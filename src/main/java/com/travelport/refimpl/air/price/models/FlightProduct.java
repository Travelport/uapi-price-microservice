...
public class FlightProduct {
     ...
     */
    public FlightProduct(String type, List<Integer> segmentSequence, String classOfService, String cabin, String fareBasisCode, Boolean privateFareInd, Brand brand) {
        super();
        this.type = type;
