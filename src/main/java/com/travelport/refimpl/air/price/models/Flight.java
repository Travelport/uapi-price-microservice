...
public class Flight {
     ...
     * @param carrier
     */
    public Flight(String type, String id, String flightRef, Integer distance, Integer stops, String duration, String carrier, String number, String operatingCarrier, String operatingCarrierName, List<String> equipment, Departure departure, Arrival arrival, List<IntermediateStop> intermediateStop) {
        super();
        this.type = type;
        this.id = id;
