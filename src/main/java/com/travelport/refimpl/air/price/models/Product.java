...
public class Product {
     ...
     */
    public Product(String type, String id, String productRef, String totalDuration, Integer quantity, List<FlightSegment> flightSegment, List<PassengerFlight> passengerFlight) {
        super();
        this.type = type;
        this.id = id;
