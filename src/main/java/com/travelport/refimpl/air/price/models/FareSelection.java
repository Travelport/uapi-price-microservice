...
public class FareSelection {
     ...
     */
    public FareSelection(String type, String fareType, String validatingCarrier, String overrideCarrier, Boolean prohibitMinStayFaresInd, Boolean prohibitMaxStayFaresInd, Boolean refundableOnlyInd, Boolean prohibitAdvancePurchaseFaresInd) {
        super();
        this.type = type;
